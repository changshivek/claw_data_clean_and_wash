...
def _build_insert_row_from_payload(data: dict) -> tuple:
    ...
    return (
        sample["sample_uid"],
        json.dumps(sample["normalized_messages"], ensure_ascii=False),
        json.dumps(sample["normalized_tools"], ensure_ascii=False),
        json.dumps(sample["normalized_user_turns"], ensure_ascii=False),
        json.dumps(sample["source_metadata"], ensure_ascii=False),
        sample["items_path"],
        sample["source_path"],
        sample["line_number"],
        sample["byte_offset"],
