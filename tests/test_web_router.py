...
def test_go_to_detail_persists_return_target():
    ...
    go_to_detail(params, sample_id=42, return_to="tables")
    route = read_route(params)

    assert route.page == "detail"
    assert route.sample_id == 42
...
def test_go_back_returns_to_source_page():
    params: dict[str, str] = {}
    route = go_to_detail(params, sample_id=7, return_to="filter")
...
def test_go_to_page_clears_detail_context():
    params: dict[str, str] = {"page": "detail", "sample_id": "9", "return_to": "tables"}
